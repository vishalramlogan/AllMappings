...
exports.deleteUser = function(req,res){
    const deleteUserInfo = (user) => {
        ...
        .then(() => user)
        .catch((error) => console.log(error));
        VideoTelephony.deleteMany({username: req.body.username})
        .then(() => user)
        .catch((error) => console.log(error));
...
exports.allOfAUser = function(req, res) {
    Users.find({ username: req.query.username })
        ...
        Promise.all([
            ...
            const mappings = [    { name: 'audioStreamingHR', data: results[0] },
            { name: 'audioStreamingLR', data: results[1] },
            { name: 'eModelFullband', data: results[2] },
            { name: 'eModelNarrowband', data: results[3] },
            { name: 'eModelWideband', data: results[4] },
            { name: 'gaming', data: results[5] },
            { name: 'videoStreamingHR', data: results[6] },
            { name: 'videoStreamingLR', data: results[7] },
            { name: 'videoTelephony', data: results[8] },
            { name: 'voiceTelephonyNarrowband', data: results[9] },
            { name: 'voiceTelephonyWideband', data: results[10] },
            { name: 'web1PageSession', data: results[11] },
            { name: 'web2PageSession', data: results[12] },
            { name: 'webSingleTimingEvent', data: results[13] }
            ];
            res.status(201).json({
                mappings
            });
