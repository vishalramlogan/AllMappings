...
exports.EModelFullband_post = function(req,res){
    if (req.body.packetLossProb > 100 || req.body.packetLossProb < 0){
        ...
        var Ta = 1*req.body.absoluteDelay, // absolute delay 
        Ppl = 1*req.body.packetLossProb, //packet Loss Probability
        Ie_FB =  1*req.body.equipmentImpairmentFac, // equipment Impairment Factor
        Bpl = 1*req.body.packetLossImpairmentFac; //packet Loss Robustness Factor
