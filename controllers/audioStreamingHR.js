...
exports.AudioStreamingHR_post = function(req,res){
    if (req.body.rtpPacketLoss > 100 || req.body.rtpPacketLoss < 0){
        return res.status(400).json({
            message: 'RTP Packet Loss should be between 1 and 100'
        }); //Bad Request
    }else if(req.body.audioCodec != 'Mp2' && req.body.audioCodec != 'AC3' && req.body.audioCodec != 'AacLC' && req.body.audioCodec != 'HeAac'){
        return res.status(400).json({
            message: 'Enter a valid Audio Codec from table'
        }); //Bad Request
    }else {
        var BitrateA = req.body.audioBitrate, //audioBitrate
        BitrateV  = req.body.videoBitrate, // videoBitrate
        RTPpacketLoss = req.body.rtpPacketLoss, // rtpPacketLoss
        RTPburstiness = req.body.rtpPacketLossBurstiness, //rtpPacketLossBurstiness
        D = req.body.numRTPPacketsTSPackets, // numRTPPacketsTSPackets
        audioCodec = req.body.audioCodec,
        burstLengthA = req.body.burstLengthA;
