...
exports.EmodeleWideband_post = function(req,res){
    if (req.body.packetLossProb > 100 || req.body.packetLossProb < 0){
        ...
        var T = 1*req.body.meanOneWayDelay, // round Trip Delay
        Ppl = 1*req.body.packetLossProb, // packet Loss Probability
        TELR = 1*req.body.talkerEchoLoudRating, // talker Echo Loudness Rating
        Ie_WB = 1*req.body.equipmentImpairment, // equipment Impairment Factor
        Ta = 1*req.body.absoluteDelay, // absolute Delay
        Tr = 1*req.body.roundTripDelay, // round Trip Delay
        WEPL = 1*req.body.weightedEchoPathLoss, // weighted Echo Path Loss
        Bpl = 1*req.body.packetLossRobustness; // packetLossRobuestnessFactor
