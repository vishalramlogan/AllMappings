...
exports.VideoStreamingHR_post =function(req,res){
    if (req.body.sliceFrame > 1 || req.body.sliceFrame  < 0){
    ...
    }else if(req.body.videoResolution  != 'HD' && req.body.videoResolution  != 'SD'){
        return res.status(400).json({
            message: 'Video resolution must be HD or SD'
        }); //Bad Request
    }else{
        var NumPixelsPerFrame =req.body.numPixelsPerVideo , //numPixelsPerVideo
        videoResolution = req.body.videoResolution ,
        sliceFrame = req.body.sliceFrame ,
        BitrateV =req.body.videoBitrate , //videoBitrate
        FrameRate = req.body.frameRate ,
        videoPLC = req.body.videoPLC ,
        FreezingRatio = req.body.freezingRatio ,
        LossMagnitude = req.body.lossMagnitude ;
