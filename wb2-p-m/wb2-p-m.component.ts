...
import { WebBrowsing2 } from '../../webbrowsing.model';
...
export class WB2PMComponent implements OnInit {
  ...
  webbrowsings: WebBrowsing2[] = [];

  ngOnInit(): void {
    this.webbrowsingsSub = this.webbrowsingService.getWeb2UpdateListner().subscribe((webbrowsings: WebBrowsing2[])=>{
