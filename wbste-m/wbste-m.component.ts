...
import { WebBrowsingSTE } from '../../webbrowsing.model';
...
export class WBSTEMComponent implements OnInit{
  ...
  webbrowsings: WebBrowsingSTE[] = [];

  ngOnInit(): void {
    this.webbrowsingsSub = this.webbrowsingService.getWebSTEUpdateListner().subscribe((webbrowsings: WebBrowsingSTE[])=>{
